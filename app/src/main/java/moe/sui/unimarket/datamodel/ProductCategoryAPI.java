...
public class ProductCategoryAPI {
    ...
    public static List<ProductCategory> listCategory(){
        ...
        try (Response response = client.newCall(request).execute()) {
            ...
            // 如果成功返回Category数组
            return gson.fromJson(Objects.requireNonNull(response.body()).string(), new TypeToken<List<ProductCategory>>(){}.getType());
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
